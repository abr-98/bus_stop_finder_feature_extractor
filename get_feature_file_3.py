...
class generateFeatureFiles():
    ...
    def __init__(self,DATA_FOLDER,INPUT_FOLDER):
        ...
        self.rsi_x_file_names_data={}
        self.rsi_y_file_names_data={}
        self.rsi_z_file_names_data={}
        self.gyro_x_file_names_data={}
        self.gyro_y_file_names_data={}
        self.gyro_z_file_names_data={}
    ...
    def store_dict(self):
        ...
        for f in files:
            ...
            if a[0]=='acc':
                trail=a[1].split('.')[0]
                # print trail
                self.rsi_z_file_names_data[trail]=f
            # print a
        for f in files:
            a=f.split('_')
            # print a
            if a[0]=='acc':
                trail=a[1].split('.')[0]
                # print trail
                self.rsi_y_file_names_data[trail]=f
        for f in files:
            a=f.split('_')
            # print a
            if a[0]=='acc':
                trail=a[1].split('.')[0]
                # print trail
                self.rsi_x_file_names_data[trail]=f
        # return a
        #//=================Gyro file name data======================//
        for f in files:
            a=f.split('_')
            ...
            if a[0]=='gyro':
                trail=a[1].split('.')[0]
                # print trail
                self.gyro_z_file_names_data[trail]=f
            # print a
        for f in files:
            a=f.split('_')
            # print a
            if a[0]=='gyro':
                trail=a[1].split('.')[0]
                # print trail
                self.gyro_y_file_names_data[trail]=f
        for f in files:
            a=f.split('_')
            # print a
            if a[0]=='gyro':
                trail=a[1].split('.')[0]
                # print trail
                self.gyro_x_file_names_data[trail]=f
    ...
    def getrsi_z_Data(self,row):
       ...
       # print(trail_no)
        ...
        filename=self.rsi_z_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        print(file)
        data= file.read().splitlines()
        data=data[1:]
        ...
        # print count
        if total_count==0:
            total_count=8.123898
        row.append(total_count)

    def getrsi_y_Data(self,row):
        # [lat,long,date,time,count,trail_no,local_group_n      o,starting_leader_time,distance,timelevel,zone,day]
        #THRESHHOLD=65
        trail_no=row[5]
       ...
       # print(trail_no)
        ...
        filename=self.rsi_y_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        data= file.read().splitlines()
        data=data[1:]
    ...
    def getrsi_x_Data(self,row):
       ...
       # print(trail_no)
        ...
        filename=self.rsi_x_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        data= file.read().splitlines()
        data=data[1:]
    ...
    def getgyro_z_Data(self,row):
       ...
       # print(trail_no)
        ...
        filename=self.gyro_z_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        data= file.read().splitlines()
        data=data[1:]
    ...
    def getgyro_y_Data(self,row):
       ...
       # print(trail_no)
        ...
        filename=self.gyro_y_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        data= file.read().splitlines()
        data=data[1:]
    ...
    def getgyro_x_Data(self,row):
       ...
       # print(trail_no)
        ...
        filename=self.gyro_x_file_names_data[trail_no]
        file=open(self.input_data_folder+'/'+filename,'r')
        data= file.read().splitlines()
        data=data[1:]
    ...
    def createFeatureFile(self):
        ...
        for trail_number in self.fileDict:
            ...
            fields.append('rsi_z')
            for row in localGroupLeader:
                self.getrsi_z_Data(row)

            fields.append('rsi_y')
            for row in localGroupLeader:
                self.getrsi_y_Data(row)

            fields.append('rsi_x')
            for row in localGroupLeader:
                self.getrsi_x_Data(row)
            
            #//================================add Gyro data==================================//

            fields.append('gyro_z')
            for row in localGroupLeader:
                self.getgyro_z_Data(row)

            fields.append('gyro_y')
            for row in localGroupLeader:
                self.getgyro_y_Data(row)
            
            fields.append('gyro_x')
            for row in localGroupLeader:
                self.getgyro_x_Data(row)
